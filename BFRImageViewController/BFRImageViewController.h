...
/*! Initializes an instance of @C BFRImageViewController from the image source provided. The array can contain a mix of @c NSURL, @c UIImage, @c PHAsset, or @c NSStrings of URLS. This can be a mix of all these types, or just one. Blocks before and after dismissing. The BEFORE block must return YES to continue dismissing. */
- (instancetype _Nullable)initWithImageSource:(NSArray * _Nonnull)images beforeDismiss:(BOOL (^ __nullable)(void))before afterDismiss:(void (^ __nullable)(void))after;
